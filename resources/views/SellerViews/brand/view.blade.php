        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-pills mb-3">
                    <li class="nav-item"><a href="#navpills-1" class="nav-link active" data-toggle="tab" aria-expanded="false">View Brands</a>
                    </li>
                    <li class="nav-item"><a href="#navpills-2" class="nav-link" data-toggle="tab" aria-expanded="false">Add New Brand</a>
                    </li>
                </ul>
                    ...
                    <div id="navpills-1" class="tab-pane active">
                        <div class="row align-items-center mb-4s">
                            ...
                            <div class="col-sm-6 col-md-3 col-xl-3 mt-4">
                                <div class="">
                                <img src="{{asset('assets/SellerImages/brand/').$item->image}}" alt="" style="width:200px; border-radius: 25px;" class="img-fluid thumbnail m-r-15">
                                <span style="display:flex; justify-content:center">{{$item->name}}</span>
                                    <div class="col-md-12">
                                        <div class="container d-flex justify-item-center" style="background-color:lightgray; width:100%;">
                                            <a href="{{route('seller.brand.removeImage',$item->id)}}"><input type="button" class="btn btn-danger ml-3" value="Delete" style="width: 100%;"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-8 col-xl-10">
                                <div class="col-md-6 mb-4">
                                    <form action="{{route('seller.brand.addBrand')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="col-auto">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <input type="text" name="image_name" class="form-control mb-2" placeholder="Brand Name" required>
                                        </div>
                                        <div class="col-auto">
