                                    ...
                                    <form action="">
                                        <div class="row mt-4">
                                            <div class="col-md-6 col-lg-6 my-3">
                                                <div class="form-group focused">
                                                    ...
                                                    <select type="date" name="Language" id="Language"
                                            ...
                                            <div class="col-md-6 col-lg-6 my-3">
                                                <div class="form-group focused">
                                                    <label class="form-control-label" for="Departments">Explicit Content
                                                        <span class="text-danger">*</span></label>
                                                    <select type="date" name="department" id="Departments"
                                                        class="form-control form-control-select ">
                                                        <option value="" class="form-control form-control-select py-2"
                                                            disabled selected>Select</option>
                                                        <option value="" class="form-control form-control-select py-2">
                                                            Explicit</option>
                                                        <option value="" class="form-control form-control-select py-2">Not
                                                            Explicite</option>
                                                        <option value="" class="form-control form-control-select py-2">
                                            ...
                                            <div class="col-md-6 col-lg-6 my-3">
                                                <div class="form-group focused">
                                                    ...
                                                    <input type="text" name="compilation" id="input-rate"
                                                        ...
                                                        placeholder="Compilation" value="{{ old('compilation') }}"
                                                        required="">
                                                    @error('compilation')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                            ...
                                            <div class="col-md-12 col-lg-12 my-3">
                                                <div class="form-group focused">
                                                    ...
                                                    <input type="text" name="record" id="input-rate"
                                                        ...
                                                        placeholder=" Record Label Name" value="{{ old('record') }}"
                                                        required="">
                                                    @error('record')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <input type="year" name="composition[year]" id="input-rate"
                                                                ...
                                                                placeholder="2021" value="{{ old('composition[year]') }}"
                                                                required="">
                                        ...
                                        <div class="px-4 py-4"
                                            ...
                                            <div class="form-group focused mt-3">
                                                <label class="form-control-label mb-3" for="">Artist name <span
                                                        class="text-danger">*</span></label>
                                                <div class="row mb-3">
                                                    <div class="col-md-3">
                                                        <input type="text" name="" id="input-rate" class="form-control"
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <button class="btn btn-primary btn-lg col-md-2 py-2 add" type="button"
                                                    data-id="1" style="font-size:18px;border-radius: 15px">Add</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-icons">
                                    <label for="country" class="col-sm-2"><span
                                            class="h6 small bg-white text-muted pt-1 pl-2 pr-2">Country</span></label>
                                    <select id="country" class="form-control mt-n3 select-payment">
                                        <option selected disabled>Select Country</option>
                                        @foreach ($countries as $country)
                                            <option value="{{ $country }}"
                                                class="form-control form-control-alternative py-2">{{ $country }}
                                            </option>
                                        @endforeach
