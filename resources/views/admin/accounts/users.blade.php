        ...
        <div class="container-fluid">
            ...
            <div class="content-body" style="margin-top: 7rem;">
                <div class="mb-3 text-white">
                    ...
                    <button class="btn btn-dark rounded px-4 py-2 text-light border-0 ml-2 outline-none" id="add-user">Add
                        User</button>
                </div>
                {{-- @if (!empty($users)) --}}
                <div id="user-table"  class="table-responsive" style=" @if ($errors->any()) display:none; @endif">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('admin/delete_user/' . $user->id) }}"
                                                class="btn btn-danger ml-2 m-1">Delete</a>
                                        </td>
                                    </tr>
                                    @php $i++ @endphp
                                @endforeach --}}
                ...
                {{-- @endif --}}
                <div id="add-user-form" class="shadow" style=" @if ($errors->any()) display:block;
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group yes_no_radio">
                                            <input type="radio" name="admin_user?" class="yes_no_radio" id="admin_user_no"
                                                value="0" checked>
                                            <label for="admin_user_no" class="label2">
                                                <span class="yes_no_span">No - Only View Specific Accounts</span>
                                            </label>
                                            <input type="radio" name="admin_user?" class="yes_no_radio" id="admin_user_yes"
                                                value="1">
                                            <label for="admin_user_yes" class="label1">
        ...
        $(document).ready(function() {
            $(document).ready(function() {
                ...
                $(document).on('click', '#users', function() {
                    $(this).removeClass('btn-dark').addClass('btn-success');
                    $("#add-user").removeClass('btn-success').addClass('btn-dark');
                    $('#add-user-form').fadeOut(1000).promise().done(function() {
                        $('#user-table').fadeIn();
                    });
                });
